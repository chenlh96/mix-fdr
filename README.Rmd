...
To run the simulation code, we first need the following the packages that provide various empirical Bayes method.
...
* `N_null = 200` : the dense setting on effect size, correspondd to figure 3
